// 1. Start building the container for the revealing module:
...
// console.log('functionName should detect "": ' + reflection.functionName(function () { }));
...
// 3. Implement the methods one by one and test
const reflection = (function () {
  function functionName(funct) {
    // SIMPLE
