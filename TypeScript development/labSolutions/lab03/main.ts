...
console.log(2 + '2'); // 22
console.log(2 * '2'); // compile error
var a: string; console.log(typeof a); // undefined, compile error with `--strict-null-checks`
var b: never; console.log(typeof b); // undefined, compile error with `--strict-null-checks`
